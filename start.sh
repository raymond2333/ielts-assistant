...
export LEGACY_STREAMLIT_URL="http://127.0.0.1:${STREAMLIT_PORT}"
export NEW_FLASK_URL="http://127.0.0.1:${WEB_PORT}"

echo ""
echo "╔════════════════════════════════════════╗"
echo "║        信达雅 IELTS 学习平台          ║"
echo "╠════════════════════════════════════════╣"
echo "║  Beta 版  → http://127.0.0.1:${WEB_PORT}   ║"
echo "║  稳定版  → http://127.0.0.1:${STREAMLIT_PORT}  ║"
echo "║  跨版本免登录已启用                    ║"
echo "╚════════════════════════════════════════╝"
echo ""
